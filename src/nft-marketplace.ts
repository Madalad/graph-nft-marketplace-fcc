...
import {
  ...
  ListingCancelled as ItemCancelledEvent
} from "../generated/NftMarketplace/NftMarketplace"
//import { ExampleEntity } from "../generated/schema"
import {
  ItemListed, ActiveItem, ItemBought, ItemCancelled
...
export function handleItemBought(event: ItemBoughtEvent): void {
  ...
  // we do not have ItemBought object
  // the object is what we save
  // import them!
  ...
  activeItem!.buyer = event.params.buyer // ! means activeItem will not be undefined
...
export function handleListingCancelled(event: ItemCancelledEvent): void {
